...
export function generateContacts(user) {
    ...
    const searchIcon = $("<img>").addClass("h-5 absolute left-3").attr("src", "../assets/svg/search.svg").attr("alt", "search icon");
    ...
    const groupLink = $('<a>');
    const addGroupButton = $("<img>").addClass(" add-group-button h-10 mr-3").attr("src", "../assets/svg/addGroup.svg").attr("alt", "add group button");
