...
export function formGroup() {
    ...
    const labelDescripcion = $("<label>").attr("for", "descripcion-grupo").text("Descripción del grupo").addClass("text-md font-bold w-full");
    ...
    labelDescripcion.append(inputDescripcion);
    ...
    const containerUsersWrapper = $("<div>").addClass("w-full flex flex-col items-start mt-3");
    ...
    const button = $("<button>").text("Crear grupo").addClass(`w-[30rem] p-3 mb-3 text-white rounded-2xl bg-[${sendButton}] hover:bg-[${accentColor}] absolute bottom-0 left-1/2 transform -translate-x-1/2`);
