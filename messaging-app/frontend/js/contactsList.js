...
function generateContacts() {
    ...
    function renderContacts(allContacts) {
        ...
        allContacts.forEach(contact => {
            ...
            const profileImage = $("<img>").addClass("profile-image h-20 w-20 sm:min-h-20 sm:min-w-20 md:max-w-20 lg:max-w-24 lg:max-h-22 min-h-20 min-w-20 max-h-16 max-w-16 rounded-full").attr("src", contact.imageUrl);
