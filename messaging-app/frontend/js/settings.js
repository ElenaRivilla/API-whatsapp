...
export function chatSettings(){
    ...
    const modeDiv = $("<div>").addClass(`modeChanger w-20 h-full bg-[${receivedMsg}] rounded-full cursor-pointer transition duration-300 peer-checked:before:translate-x-12 peer-checked:before:bg- before:content-[''] before:absolute before:top-1 before:left-1 before:bg-white before:w-6 before:h-6 before:rounded-full before:transition before:duration-300`);
